...
private String callNo;
	...
	private int year;
        public Book1(){}
	public Book1(String callNo, String name, String author, String publisher, int quantity, int issuedNo, int day,int month, int year) {
...
public void addIssuedBook(String s1,String s2,String s3,String s4) throws IOException{
       Date thisDate =new Date();
    SimpleDateFormat dformat= new SimpleDateFormat("dd MM yyyy");
         String date =dformat.format(thisDate);
           
    FileWriter fw = new FileWriter( new File("C:\\Users\\Ahmed gamal\\Documents\\NetBeansProjects\\Gui\\src\\gui\\IssuedBooks.txt"),true);
      fw.write(s1+" ");
    fw.write(s2+" ");
    fw.write(s3+" ");
    ...
    fw.write(date+"\n");
        ...
        fw.close();
        JOptionPane.showMessageDialog(null, "  Issued Book added");
